...
const Sidebar = () => {
  ...
  const sidebarContent = (
    <>
      ...
      <div className="px-5 pt-5 pb-2">
        ...
        tracking-[0.12em] text-shadow-taupe-500"
        >
          Navigation
        </p>
      </div>
      ...
      <div className=" flex-1 px-3 space-y-0.5 overflow-y-auto">
        {loading ? (
          ...
          navItems.map((item) => {
            ...
            rounded-md text-[13px] font-medium transition-all duration-150
            relative ${
              isActive
              ...
              >
                {isActive && (
                  <div
                    className="absolute
                left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 rounded-r-full
              bg-indigo-500"
                  />
                )}
                <item.icon
      ...
      <div className=" p-3 border-t border-white/6">
        <button
         ...
         hover:text-rose-400 hover:bg-red-500/8 transition-all duration-150"
        >
  ...
  return (
    <>
      ...
      {/* Sidebar Desktop */}
      <aside
        className="hidden lg:flex flex-col h-full w-[260px] bg-linear-to-b
      from-slate-900 via-slate-900 to-slate-900 text-white
