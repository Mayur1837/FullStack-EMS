  ...
  const portalOptions = [
    {
      ...
      title: "Admin Portal",
      description:
        "Manage employees,departments and payrolls and systems configurations.",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
      ...
      description:
        "View your profile,track attendance,request time off and acess payslips ",
      icon: UserIcon,
    },
  ];
        ...
        <div className="w-full max-w-d animate-fade-in relative z-10">
          ...
          <div className="space-y-4">
            {portalOptions.map((portal) => (
              ...
              sm:p-6 transition-all duration-300 hover:border-indigo-400
              hover:bg-indigo-50"
              >
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>
              © {new Date().getFullYear()} Fullstack_EMS. All rights reserved.
            </p>
          </div>
        </div>
      </div>
